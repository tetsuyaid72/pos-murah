    ...
    <main className="relative min-h-screen overflow-x-hidden bg-[#F8FAFC] px-4 text-slate-950 sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col">
        ...
        <section id="pricing" className="flex flex-1 flex-col items-center justify-start pb-7 pt-6 text-center sm:justify-center sm:pb-8 sm:pt-0">
          ...
          <h1 className="mt-4 max-w-full whitespace-nowrap text-[28px] font-black leading-tight tracking-[-0.045em] text-emerald-600 sm:mt-5 sm:text-5xl lg:text-5xl">
          ...
          <div className="mt-8 grid w-full gap-4 sm:mt-8 sm:max-w-md md:max-w-none md:grid-cols-3 lg:gap-4">
            {plans.map((plan) => (
              <Card
                key={plan.name}
                className={
                  plan.highlighted
                    ? 'relative flex h-full flex-col rounded-[24px] border-2 border-emerald-500 bg-white/95 text-left shadow-[0_22px_64px_rgba(16,185,129,0.16)] backdrop-blur sm:rounded-[26px]'
                    : 'flex h-full flex-col rounded-[24px] border-slate-200/80 bg-white/85 text-left shadow-[0_14px_44px_rgba(15,23,42,0.055)] backdrop-blur sm:rounded-[26px]'
                }
              >
                {plan.highlighted && (
                ...
                <CardHeader className="p-5 pb-3 sm:p-5 sm:pb-3">
                ...
                <CardContent className="flex-1 p-5 pt-0 sm:p-5 sm:pt-0">
                  {plan.highlighted ? (
                    <div>
                      <div className="flex items-end gap-2">
                        <span className="text-3xl font-black tracking-[-0.04em] text-slate-950 sm:text-4xl">{plan.price}</span>
                  ...
                  <ul className="mt-5 space-y-2.5 sm:mt-5 sm:space-y-2.5">
                ...
                <CardFooter className="mt-auto p-5 pt-0 sm:p-5 sm:pt-0">
