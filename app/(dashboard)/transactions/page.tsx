        ...
        <div className="space-y-2 px-4 pt-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Select
              ...
              className="h-11 rounded-2xl border-border bg-card px-4 text-sm font-medium text-foreground shadow-sm"
            >
            ...
            <div className="relative h-11">
              <button
                type="button"
                className="flex h-11 w-full items-center justify-between rounded-2xl border border-border bg-card px-4 text-sm font-medium text-foreground shadow-sm"
              >
